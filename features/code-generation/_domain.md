...
- [[component-spec-generation--from-ai-website-cloner-template]] — spec-driven component docs giving AI builders exact CSS values, interaction models, and asset paths so they can reconstruct any website section accurately (part of the website cloning pipeline).
...
- Feeds [[web-cloning/website-cloning-pipeline--from-ai-website-cloner-template]] — component specs are the intelligence layer between reconnaissance and construction.
