...
- [[tool-calling-agent--from-langchain]] — @tool decorator, bind_tools(), ToolCall/ToolMessage round-trip, and the ReAct agent loop (AgentExecutor) that cycles until AgentFinish
