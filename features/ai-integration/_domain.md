...
## From scira
- **scira** — [[multi-provider-model-gateway--from-scira]]: one alias per model over ~130 models/22 providers; client-safe metadata split from secret-bearing provider wiring.
